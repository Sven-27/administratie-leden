    ...
    <main class="login">
        <section id="login">
            <form id="login" method="post">
                ...
                <input class="login-input" type="login_email" name="login_email" id="login_email" placeholder="voorbeeld@google.com" required>
                <label for="login_password">
                    Wachtwoord <?php if (isset($error_password)) echo '<span class="error">' . $error_password . '</span>'; ?>
                </label>
                <input class="login-input" type="password" name="login_password" id="login_password" required placeholder="&bullet;&bullet;&bullet;&bullet;&bullet;&bullet;">
                <input class="login-input" type="submit" value="Inloggen" name="login" id="login_submit">
            </form>
        </section>
